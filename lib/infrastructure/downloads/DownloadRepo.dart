...
@LazySingleton(as: DownloadRepo)//converting into singlton ,2) @ block add @injectable and create a dependency injection function for initilizing getit and initialize the configureInjection function at the run app section
